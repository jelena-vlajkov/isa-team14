  ...
  registerDermatologist(){
    ...
    if(this.googleplaces.address===undefined){
      ...
      if(this.password === this.confirmPassword){
         this.dermatologist = new Dermatologist(null, this.name, this.surname, this.dateOfBirth, this.phone, this.email.toLowerCase(), this.password, this.gender, this.address, role, auths, this.chosenPharmacies,null);
