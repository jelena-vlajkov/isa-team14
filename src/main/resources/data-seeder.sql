...
insert into pharmacies(id, excellent, very_good, good, poor, very_poor, description, email, name, telephone, address_id) values (100, 1, 0, 0, 0, 0, 'Prodicna apoteka osnovana od starne pozrtvovane porodice Jankovic. Nas moto je pls kupujte kod nas :D', 'jankovicapoteka@gmail.com' ,'Apoteka Jankovic', 01212432 ,1500);
insert into pharmacies(id, excellent, very_good, good, poor, very_poor, description, email, name, telephone, address_id) VALUES (200, 1,  0, 0, 0, 0, 'Nmp uleteli smo na trziste ko ludi, kupili veliki broj lokala i sad ono, zatvaramo polako.','zegin@gmail.com','ZEGIN',011123417,1400);
insert into pharmacies(id, excellent, very_good, good, poor, very_poor, description, email, name, telephone, address_id) VALUES (300, 5,  0, 0, 0, 0, 'Veoma moderna apoteka, nudi usluge i preko donesi.com aplikacije.', 'benu@gmail.com','Apoteka Benu',91236234,1300);
insert into pharmacies(id, excellent, very_good, good, poor, very_poor, description, email, name, telephone, address_id) VALUES (400, 5,  0, 0, 0, 0, 'Jedna od najstarijih apoteka u Novom Sadu i jedna od poslednjih koja aktivno saradjuje sa vojnom bolnicom.','laurusns@hotmail.com','Apoteka Laurus',0124532,1200);
...
insert into dermatologists(id, excellent, very_good, good, poor, very_poor) values (100, 1, 0, 0, 0, 0);
insert into dermatologists(id, excellent, very_good, good, poor, very_poor) values (600, 1, 0, 0, 0, 0);
insert into dermatologists(id, excellent, very_good, good, poor, very_poor) values (300, 1, 0, 0, 0, 0);
insert into dermatologists(id, excellent, very_good, good, poor, very_poor) values (1100, 1, 0, 0, 0, 0);
