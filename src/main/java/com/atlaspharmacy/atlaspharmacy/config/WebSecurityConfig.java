...
import com.atlaspharmacy.atlaspharmacy.security.auth.RestAuthenticationEntryPoint;
import com.atlaspharmacy.atlaspharmacy.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/**").permitAll().antMatchers("/activation").permitAll().antMatchers("/auth/**").permitAll().antMatchers("/h2-console/**").permitAll().antMatchers("/api/foo").permitAll()
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers("/patient/**");
