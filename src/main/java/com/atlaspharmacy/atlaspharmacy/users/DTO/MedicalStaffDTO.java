...
public class MedicalStaffDTO {
    ...
    public MedicalStaffDTO(Long id, String name, String surname, Date dateOfBirth,
                           String phoneNumber, String email, String password,
                           Gender gender, AddressDTO address, String role,
                           List<AuthorityDTO> authorities, boolean firstTimeChanged,String licenceNumber) {
        this.id = id;
        this.name = name;
